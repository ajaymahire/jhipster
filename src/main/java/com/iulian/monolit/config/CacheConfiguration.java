package com.iulian.monolit.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.iulian.monolit.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.iulian.monolit.repository.UserRepository.USERS_BY_EMAIL_CACHE);
