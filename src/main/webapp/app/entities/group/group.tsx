...
export const Group = (props: IGroupProps) => {
  ...
  return (
    <div>
      <h2 id="group-heading">
        <Translate contentKey="monolitApp.group.home.title">Groups</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="monolitApp.group.home.createLabel">Create new Group</Translate>
        </Link>
      </h2>
          ...
          {groupList && groupList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('name')}>
                    <Translate contentKey="monolitApp.group.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('description')}>
                    <Translate contentKey="monolitApp.group.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="monolitApp.group.user">User</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {groupList.map((group, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{group.userLogin ? group.userLogin : ''}</td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="monolitApp.group.home.notFound">No Groups found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
